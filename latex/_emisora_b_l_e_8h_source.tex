\hypertarget{_emisora_b_l_e_8h_source}{}\doxysection{Emisora\+BLE.\+h}
...
\DoxyCodeLine{21 \textcolor{preprocessor}{\#include "{}\mbox{\hyperlink{_servicio_en_emisora_8h}{ServicioEnEmisora.h}}"{}}}
\DoxyCodeLine{22 }
\DoxyCodeLine{23 \textcolor{comment}{// -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{24 \textcolor{comment}{// -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{25 \textcolor{keyword}{class }\mbox{\hyperlink{class_emisora_b_l_e}{EmisoraBLE}} \{}
...
\DoxyCodeLine{36   \textcolor{keyword}{using }\mbox{\hyperlink{class_emisora_b_l_e_a2b5da98f1f7994b60de9349adc46538d}{CallbackConexionEstablecida}} = void ( uint16\_t connHandle );}
\DoxyCodeLine{37   \textcolor{keyword}{using }\mbox{\hyperlink{class_emisora_b_l_e_a2677eaf92c789ee6ff2bf3dfd34fbeeb}{CallbackConexionTerminada}} = void ( uint16\_t connHandle, uint8\_t reason);}
\DoxyCodeLine{38 }
\DoxyCodeLine{39   \textcolor{comment}{// .........................................................}}
\DoxyCodeLine{40   \textcolor{comment}{// .........................................................}}
\DoxyCodeLine{41   \mbox{\hyperlink{class_emisora_b_l_e_a0a00423c1458d93ff7865c0d508459ad}{EmisoraBLE}}( \textcolor{keyword}{const} \textcolor{keywordtype}{char} * nombreEmisora\_, \textcolor{keyword}{const} uint16\_t fabricanteID\_,}
...
\DoxyCodeLine{75   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_emisora_b_l_e_adbefd34b570bc58380da42e77527c3ce}{encenderEmisora}}() \{}
...
\DoxyCodeLine{85   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_emisora_b_l_e_a881902d925f327ec142009de7e10355e}{encenderEmisora}}( \mbox{\hyperlink{class_emisora_b_l_e_a2b5da98f1f7994b60de9349adc46538d}{CallbackConexionEstablecida}} cbce,}
\DoxyCodeLine{86                         \mbox{\hyperlink{class_emisora_b_l_e_a2677eaf92c789ee6ff2bf3dfd34fbeeb}{CallbackConexionTerminada}} cbct ) \{}
\DoxyCodeLine{87 }
\DoxyCodeLine{88     \mbox{\hyperlink{class_emisora_b_l_e_adbefd34b570bc58380da42e77527c3ce}{encenderEmisora}}();}
\DoxyCodeLine{89 }
\DoxyCodeLine{90     \mbox{\hyperlink{class_emisora_b_l_e_aa31978c852802e08f6706f5108bd742c}{instalarCallbackConexionEstablecida}}( cbce );}
\DoxyCodeLine{91     \mbox{\hyperlink{class_emisora_b_l_e_a4ca1aeede06f377c8026f3416a78221d}{instalarCallbackConexionTerminada}}( cbct );}
\DoxyCodeLine{92 }
\DoxyCodeLine{93   \} \textcolor{comment}{// ()}}
\DoxyCodeLine{94 }
\DoxyCodeLine{95   \textcolor{comment}{// .........................................................}}
\DoxyCodeLine{96   \textcolor{comment}{// .........................................................}}
\DoxyCodeLine{97   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_emisora_b_l_e_ac46ff05d8af2388d14c8006daa8be97d}{detenerAnuncio}}() \{}
\DoxyCodeLine{98 }
...
\DoxyCodeLine{109   \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_emisora_b_l_e_aefb25aa471115728b45a7c096965ff76}{estaAnunciando}}() \{}
...
\DoxyCodeLine{115   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_emisora_b_l_e_ac79d557cecd4476d72bb519beb5f29c2}{emitirAnuncioIBeacon}}( uint8\_t * beaconUUID, int16\_t major, int16\_t minor, uint8\_t rssi ) \{}
\DoxyCodeLine{116 }
...
\DoxyCodeLine{203   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_emisora_b_l_e_a7a728aa8ab6975905cb67b918e4d12ca}{emitirAnuncioIBeaconLibre}}( \textcolor{keyword}{const} \textcolor{keywordtype}{char} * carga, \textcolor{keyword}{const} uint8\_t tamanyoCarga ) \{}
\DoxyCodeLine{204 }
...
\DoxyCodeLine{259 }
\DoxyCodeLine{260     \mbox{\hyperlink{namespace_globales_a8479052d558297793d6f1c8b11cf45d4}{Globales::elPuerto}}.\mbox{\hyperlink{class_puerto_serie_ae06c3c158490e837bb9b582967ccd88b}{escribir}}( \textcolor{stringliteral}{"{}emitiriBeacon libre  Bluefruit.Advertising.start( 0 );  \(\backslash\)n"{}});}
\DoxyCodeLine{261   \} \textcolor{comment}{// ()}}
\DoxyCodeLine{262 }
\DoxyCodeLine{263   \textcolor{comment}{// .........................................................}}
\DoxyCodeLine{264   \textcolor{comment}{// .........................................................}}
\DoxyCodeLine{265   \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_emisora_b_l_e_a8536957b6a7ec181313367caaa317ed8}{anyadirServicio}}( \mbox{\hyperlink{class_servicio_en_emisora}{ServicioEnEmisora}} \& servicio ) \{}
\DoxyCodeLine{266 }
\DoxyCodeLine{267     \mbox{\hyperlink{namespace_globales_a8479052d558297793d6f1c8b11cf45d4}{Globales::elPuerto}}.\mbox{\hyperlink{class_puerto_serie_ae06c3c158490e837bb9b582967ccd88b}{escribir}}( \textcolor{stringliteral}{"{} Bluefruit.Advertising.addService( servicio ); \(\backslash\)n"{}});}
\DoxyCodeLine{268 }
...
\DoxyCodeLine{284   \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_emisora_b_l_e_a5474e5ad5fe4c71aa0018775785b62fb}{anyadirServicioConSusCaracteristicas}}( \mbox{\hyperlink{class_servicio_en_emisora}{ServicioEnEmisora}} \& servicio ) \{ }
...
\DoxyCodeLine{290   \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_emisora_b_l_e_a66e49a1f4418fe20804b16c7a35d1fb7}{anyadirServicioConSusCaracteristicas}}( \mbox{\hyperlink{class_servicio_en_emisora}{ServicioEnEmisora}} \& servicio,}
\DoxyCodeLine{291                                              \mbox{\hyperlink{class_servicio_en_emisora_1_1_caracteristica}{ServicioEnEmisora::Caracteristica}} \& caracteristica,}
\DoxyCodeLine{292                                              T\& ... restoCaracteristicas) \{}
\DoxyCodeLine{293 }
\DoxyCodeLine{294     servicio.\mbox{\hyperlink{class_servicio_en_emisora_a1addea6271eae8c3f82dfa6271a5758a}{anyadirCaracteristica}}( caracteristica );}
\DoxyCodeLine{295 }
\DoxyCodeLine{296     \textcolor{keywordflow}{return} \mbox{\hyperlink{class_emisora_b_l_e_a5474e5ad5fe4c71aa0018775785b62fb}{anyadirServicioConSusCaracteristicas}}( servicio, restoCaracteristicas... );}
\DoxyCodeLine{297     }
...
\DoxyCodeLine{302   \textcolor{keywordtype}{bool} \mbox{\hyperlink{class_emisora_b_l_e_a16895e037c0ef42462b9b324407fe448}{anyadirServicioConSusCaracteristicasYActivar}}( \mbox{\hyperlink{class_servicio_en_emisora}{ServicioEnEmisora}} \& servicio,}
\DoxyCodeLine{303                                                      \textcolor{comment}{// ServicioEnEmisora::Caracteristica \& caracteristica,}}
\DoxyCodeLine{304                                                      T\& ... restoCaracteristicas) \{}
\DoxyCodeLine{305 }
\DoxyCodeLine{306     \textcolor{keywordtype}{bool} r = \mbox{\hyperlink{class_emisora_b_l_e_a5474e5ad5fe4c71aa0018775785b62fb}{anyadirServicioConSusCaracteristicas}}( servicio, restoCaracteristicas... );}
\DoxyCodeLine{307 }
\DoxyCodeLine{308     servicio.\mbox{\hyperlink{class_servicio_en_emisora_a9ac5c412ee3fda94d6e2697a8838afe8}{activarServicio}}();}
\DoxyCodeLine{309 }
...
\DoxyCodeLine{316   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_emisora_b_l_e_aa31978c852802e08f6706f5108bd742c}{instalarCallbackConexionEstablecida}}( \mbox{\hyperlink{class_emisora_b_l_e_a2b5da98f1f7994b60de9349adc46538d}{CallbackConexionEstablecida}} cb ) \{}
...
\DoxyCodeLine{322   \textcolor{keywordtype}{void} \mbox{\hyperlink{class_emisora_b_l_e_a4ca1aeede06f377c8026f3416a78221d}{instalarCallbackConexionTerminada}}( \mbox{\hyperlink{class_emisora_b_l_e_a2677eaf92c789ee6ff2bf3dfd34fbeeb}{CallbackConexionTerminada}} cb ) \{}
...
\DoxyCodeLine{328   BLEConnection * \mbox{\hyperlink{class_emisora_b_l_e_a45f68bc05b6b5de37a6ea800d2cce9ef}{getConexion}}( uint16\_t connHandle ) \{}
